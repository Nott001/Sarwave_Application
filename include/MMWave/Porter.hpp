...
inline std::string sendCliCommand(Context& ctx, const std::string& command,
...
inline void sendConfigFile(Context& ctx, const std::filesystem::path& cfgPath,
                           void (*reportLine)(const std::string& line,
